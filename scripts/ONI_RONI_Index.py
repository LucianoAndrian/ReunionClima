...
ax1.fill_between(df_ONI['date'], df_ONI['ANOM'],0.5,where=df_ONI['ANOM']>=0.5,color='red')
ax1.fill_between(df_ONI['date'], df_ONI['ANOM'],-0.5,where=df_ONI['ANOM']<=-0.5,color='blue')
ax1.axhline(y=0,color='k',linewidth=0.5)
ax1.axhline(y=0.5,color='r',linewidth=0.2)
ax1.axhline(y=-0.5,color='b',linewidth=0.2)
ax1.grid(True)
ax1.set_title('ONI index')

ax2.plot(df_RONI['date'], df_RONI['ANOM'],'k',linewidth=0.6)
ax2.fill_between(df_RONI['date'], df_RONI['ANOM'],0.5,where=df_RONI['ANOM']>=0.5,color='red')
ax2.fill_between(df_RONI['date'], df_RONI['ANOM'],-0.5,where=df_RONI['ANOM']<=-0.5,color='blue')
ax2.axhline(y=0,color='k',linewidth=0.5)
ax2.axhline(y=0.5,color='r',linewidth=0.2)
ax2.axhline(y=-0.5,color='b',linewidth=0.2)
ax2.grid(True)
ax2.set_title('Relative ONI (RONI) index')
